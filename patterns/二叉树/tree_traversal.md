...
- [0144 二叉树的前序遍历](../../problems/二叉树/0144%20二叉树的前序遍历.md) 🟢（迭代：栈先右后左 + 递归 Type A 自递归合并）
- [0145 二叉树的后序遍历](../../problems/二叉树/0145%20二叉树的后序遍历.md) 🟢（取巧法：伪前序"先左后右"+ 整体反转）
- [0094 二叉树的中序遍历](../../problems/二叉树/0094%20二叉树的中序遍历.md) 🟢（游标 + 栈，迭代三序最复杂）
