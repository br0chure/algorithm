...
- [0105 从前序与中序遍历序列构造二叉树](../../problems/二叉树/0105%20从前序与中序遍历序列构造二叉树.md) 🟡（前序定根 + 中序切分）
- [0106 从中序与后序遍历序列构造二叉树](../../problems/二叉树/0106%20从中序与后序遍历序列构造二叉树.md) 🟡（后序定根 + 中序切分，105 镜像）

## 🎓 tree_construction 毕业

源 md 构造系列 2 题全刷完。两题骨架完全一致，只换"根的来源"（前序首位 / 后序末位）。

模板默写无压力 → **tree_construction 毕业**。
