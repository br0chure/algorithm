...
- [0230 二叉搜索树中第 K 小的元素](../0230%20二叉搜索树中第%20K%20小的元素.md) 🟡（中序闭包 + count 短路）
- [0108 将有序数组转换为二叉搜索树](../0108%20将有序数组转换为二叉搜索树.md) 🟢（数组上二分递归构造）
- [0700 二叉搜索树中的搜索](../0700%20二叉搜索树中的搜索.md) 🟢（左小右大单边递归）
- [0701 二叉搜索树中的插入操作](../0701%20二叉搜索树中的插入操作.md) 🟡（叶子插入 + 返回值修剪树指针）
- [0450 删除二叉搜索树中的节点](../0450%20删除二叉搜索树中的节点.md) 🟡（4 case + 子树重新拼接）
